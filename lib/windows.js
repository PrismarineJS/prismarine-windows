...
Window.prototype.acceptConcatItems = function(click){
  var clickedItem = this.slots[click.slot]
  for(var i = 0; i < this.slots.length; i++){
    var currentItem = this.slots[i]
    if(clickedItem.count < clickedItem.stackSize){
      clickedItem.count += currentItem.stackSize
      this.updateSlot(i, undefined)
    }
  }
}
