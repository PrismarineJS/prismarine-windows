function loader (registryOrVersion) {
  ...
  if (registry.isNewerOrEqualTo('1.14')) {// this line should be discarded for the one above when the corresponding feature is added to minecraft-data
    ...
    //let inventory_slots = registry.supportFeature("shieldSlot") ? 46 : 45
    let inventory_slots = registry.isNewerOrEqualTo('1.9') ? 46 : 45// this line should be discarded for the one above when the corresponding feature is added to minecraft-data
    windows = {
      'minecraft:inventory': { type: 'minecraft:inventory', inventory: { start: 9, end: 44 }, slots: inventory_slots ? 46 : 45, craft: 0, requireConfirmation: true },
